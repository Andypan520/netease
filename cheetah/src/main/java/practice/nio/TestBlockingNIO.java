...
public class TestBlockingNIO {
    ...
    public void client() throws IOException {
        ...
        FileChannel inChannel = FileChannel.open(Paths.get(PNG_1), StandardOpenOption.READ);
    ...
    public void server() throws IOException {
        ...
        FileChannel outChannel = FileChannel.open(Paths.get(PNG_2),
        ...
        //5. 接收客户端的数据，并保存到本地(png1 覆盖了 png2)
